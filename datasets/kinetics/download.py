# Modified Kinetics video downloading script from 
# https://github.com/piaxar/kinetics-downloader. 
#
# Required libraries: pytube3, joblib, pandas
#
# Instructions:
# Downloading and trimming: 
# python download.py /path/to/kinetic_split.csv /path/to/videos/ --trim
# Downloading and trimming in several jobs: 
# python download.py /path/to/kinetic_split.csv /path/to/videos/ --trim --num-jobs 10
