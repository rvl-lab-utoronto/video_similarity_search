...
#SBATCH --job-name=resnet_ucf_ic_llc_pos_sample_1.0
...
--cfg '/home/cheny257/projects/def-florian7/cheny257/code/video_similarity_search/config/custom_configs/ablation/cc_resnet_ucf_ic_llc_pos_sample1.0.yaml' \
--gpu 0,1 \
--num_data_workers 4 \
--batch_size 56 \
--output '/home/cheny257/projects/def-florian7/cheny257/output/ablation/resnet_ucf_ic_llc_pos_sample_1.0' \
--num_shards 2 \
--epoch 600 \
