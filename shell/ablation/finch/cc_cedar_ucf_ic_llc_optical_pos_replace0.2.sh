...
#SBATCH --job-name=finch_resnet_ucf_ic_llc_optical_pos_replace_0.2
...
--cfg '/home/cheny257/projects/def-florian7/cheny257/code/video_similarity_search/config/custom_configs/ablation/finch/cc_resnet_ucf_ic_llc_optical_pos_replace0.2.yaml' \
--gpu 0,1 \
--num_data_workers 4 \
--batch_size 26 \
--checkpoint_path '/home/cheny257/projects/def-florian7/cheny257/output/ablation/finch/resnet_ucf_ic_llc_optical_pos_replace_0.2/tnet_checkpoints/3dresnet/checkpoint.pth.tar' \
--output '/home/cheny257/projects/def-florian7/cheny257/output/ablation/finch/resnet_ucf_ic_llc_optical_pos_replace_0.2' \
--epoch 601 \
--compute_canada \
--iterative_cluster