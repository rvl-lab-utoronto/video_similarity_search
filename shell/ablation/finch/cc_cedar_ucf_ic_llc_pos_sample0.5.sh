...
#SBATCH --job-name=finch_resnet_ucf_ic_llc_pos_sample_0.5
...
--cfg '/home/cheny257/projects/def-florian7/cheny257/code/video_similarity_search/config/custom_configs/ablation/finch/cc_resnet_ucf_ic_llc_pos_sample0.5.yaml' \
--gpu 0,1 \
--num_data_workers 4 \
--batch_size 32 \
--output '/home/cheny257/projects/def-florian7/cheny257/output/ablation/finch/resnet_ucf_ic_llc_pos_sample_0.5' \
--epoch 601 \
--compute_canada \
--iterative_cluster \
