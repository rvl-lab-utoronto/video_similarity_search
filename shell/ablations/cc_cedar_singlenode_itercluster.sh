...
python $ROOTDIR/online_train.py --iterative_cluster --cfg $ROOTDIR/config/custom_configs/resnet_ucf_itercluster_flow_cc.yaml --gpu 0,1 --num_data_workers 4 --batch_size 32 --output $ROOTDIR/output_ucf23- --epoch 601 VAL.BATCH_SIZE 80
