...
python $ROOTDIR/online_train.py --cfg $ROOTDIR/config/custom_configs/resnet_ucf_itercluster_flow_cc.yaml --gpu 0,1 --num_data_workers 4 --batch_size 32 --output $ROOTDIR/output_ucf23-nocluster --epoch 601 --checkpoint_path $ROOTDIR/output_ucf23-nocluster/tnet_checkpoints/3dresnet/checkpoint.pth.tar VAL.BATCH_SIZE 80 DATASET.POSITIVE_SAMPLING_P 1.0 DATASET.SAMPLING_STRATEGY random_negative
