...
python $ROOTDIR/online_train.py --cfg $ROOTDIR/config/custom_configs/resnet_ucf_itercluster_flow_cc.yaml --gpu 0,1 --num_data_workers 4 --batch_size 32 --output $ROOTDIR/output_ucf23-supervised --epoch 601 --checkpoint_path $ROOTDIR/output_ucf23-supervised/tnet_checkpoints/3dresnet/checkpoint.pth.tar VAL.BATCH_SIZE 80 DATASET.POSITIVE_SAMPLING_P 0.0 DATASET.TARGET_TYPE_T label
