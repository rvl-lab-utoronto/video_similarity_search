...
srun python /home/salar77h/projects/def-florian7/salar77h/repos/video_similarity_search/online_train.py --cfg /home/salar77h/projects/def-florian7/salar77h/repos/video_similarity_search/config/custom_configs/slowfast_kinetics_cc.yaml --gpu 0,1,2,3 --num_data_workers 4 --batch_size 48 --num_shards 2 --ip_address_port tcp://$MASTER_ADDRESS:$MPORT --compute_canada --output /home/salar77h/projects/def-florian7/salar77h/repos/video_similarity_search/output_kinetics9-cluster-p-80 MODEL.ARCH 3dresnet DATASET.POSITIVE_SAMPLING_P 0.8
