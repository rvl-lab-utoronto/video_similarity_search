...
python $ROOTDIR/online_train.py --iterative_cluster --cfg $ROOTDIR/config/custom_configs/resnet_kinetics_itercluster_cc.yaml --gpu 0,1,2,3 --num_data_workers 4 --batch_size 56 --output $ROOTDIR/output_ucf25-kin-noflow-singlenode --epoch 601 --checkpoint_path $ROOTDIR/output_ucf25-kin-noflow-singlenode/tnet_checkpoints/3dresnet/checkpoint.pth.tar VAL.BATCH_SIZE 80 LOSS.LOCAL_LOCAL_CONTRAST True DATA.INPUT_CHANNEL_NUM 3 ITERCLUSTER.METHOD finch
