...
srun python -u $ROOTDIR/online_train.py --iterative_cluster --cfg $ROOTDIR/config/custom_configs/resnet_kinetics_itercluster_flow_cc.yaml --gpu 0,1,2,3 --num_data_workers 4 --batch_size 28 --output $ROOTDIR/output_ucf29-kin-r3d-single-p05-32f --epoch 401 --num_shards 2 --ip_address_port tcp://$MASTER_ADDRESS:$MPORT --compute_canada VAL.BATCH_SIZE 80 LOSS.LOCAL_LOCAL_CONTRAST True DATA.INPUT_CHANNEL_NUM 3 ITERCLUSTER.METHOD finch DATA.SAMPLE_DURATION 32 DATASET.POSITIVE_SAMPLING_P 0.5
