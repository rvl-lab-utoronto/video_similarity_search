...
#SBATCH --job-name=res_ucf_adam_32
...
python $ROOTDIR/online_train.py --iterative_cluster --cfg $ROOTDIR/config/custom_configs/resnet_ucf_itercluster_mask_cc.yaml --gpu 0,1,2,3 --num_data_workers 4 --batch_size 100 --output $ROOTDIR/output_ucf16-adam-32-2 --epoch 701 --checkpoint_path $ROOTDIR/output_ucf16-adam-32-2/tnet_checkpoints/3dresnet/checkpoint.pth.tar VAL.BATCH_SIZE 80 OPTIM.LR 0.001 DATA.SAMPLE_DURATION 32
