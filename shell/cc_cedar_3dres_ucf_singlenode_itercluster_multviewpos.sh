...
python $ROOTDIR/online_train.py --iterative_cluster --cfg $ROOTDIR/config/custom_configs/resnet_ucf_itercluster_flow_cc.yaml --gpu 0,1 --num_data_workers 4 --batch_size 56 --output $ROOTDIR/output_ucf21-augfix-2gpu-posflow25 --epoch 501 VAL.BATCH_SIZE 80 LOSS.LOCAL_LOCAL_CONTRAST True DATASET.POS_CHANNEL_REPLACE True DATASET.PROB_POS_CHANNEL_REPLACE 0.25 DATA.INPUT_CHANNEL_NUM 3
