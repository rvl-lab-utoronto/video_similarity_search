...
python $ROOTDIR/online_train.py --cfg $ROOTDIR/config/custom_configs/resnet_ucf_itercluster_mask_cc.yaml --gpu 0,1 --num_data_workers 4 --batch_size 56 --output $ROOTDIR/output_ucf21-augfix-2gpu-supervised --epoch 501 VAL.BATCH_SIZE 80 LOSS.LOCAL_LOCAL_CONTRAST True DATASET.POSITIVE_SAMPLING_P 0.0 DATASET.TARGET_TYPE_T label
