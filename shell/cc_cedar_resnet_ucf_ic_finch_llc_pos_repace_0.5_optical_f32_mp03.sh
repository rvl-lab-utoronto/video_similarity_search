...
#SBATCH --job-name=finch_resnet_ucf_ic_llc_optical_pos_sample_0.5_f32
...
--num_data_workers 4 \
--batch_size 32 \
--output '/home/cheny257/projects/def-florian7/cheny257/output/ablation/finch/resnet_ucf_ic_finch_llc_optical_f32_mp03_pos_0.5' \
--epoch 601 \
--compute_canada \
--iterative_cluster DATA.SAMPLE_DURATION 32 VAL.BATCH_SIZE 32 ITERCLUSTER.FINCH_PARTITION [0,3] DATASET.POSITIVE_SAMPLING_P 0.5
