...
#SBATCH --job-name=resnet_ucf_nce_supervised_multinodes
...
--cfg '/home/cheny257/projects/def-florian7/cheny257/code/video_similarity_search/config/custom_configs/cc_resnet_ucf_supervised_nce.yaml' \
--gpu 0,1,2,3 \
--num_data_workers 4 \
--batch_size 20 \
--output '/home/cheny257/projects/def-florian7/cheny257/output/ResNet18_U_Contrastive_NCE_supervised' \
--num_shards 2 \
--epoch 200 \
