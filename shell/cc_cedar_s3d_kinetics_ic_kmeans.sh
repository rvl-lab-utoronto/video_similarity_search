...
#SBATCH --job-name=s3d_kin_ic_kmeans_llc_optical_f32
...
--num_data_workers 4 \
--batch_size 32 \
--output '/home/cheny257/projects/def-florian7/cheny257/output/s3d_kin_ic_kmeans_llc_optical_f32' \
--checkpoint_path '/home/cheny257/projects/def-florian7/cheny257/output/s3d_kin_ic_kmeans_llc_optical_f32/tnet_checkpoints/s3d/checkpoint.pth.tar' \
--epoch 601 \
--num_shards 2 \
--ip_address_port tcp://$MASTER_ADDRESS:$MPORT \
--compute_canada \
--iterative_cluster VAL.BATCH_SIZE 32 ITERCLUSTER.METHOD 'kmeans'
