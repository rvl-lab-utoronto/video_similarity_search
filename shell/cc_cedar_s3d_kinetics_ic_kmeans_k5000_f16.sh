...
--checkpoint_path '/home/cheny257/projects/def-florian7/cheny257/output/s3d_kin_ic_kmeans_llc_optical_f16/tnet_checkpoints/s3d/checkpoint.pth.tar' \
--epoch 601 \
--num_shards 2 \
--ip_address_port tcp://$MASTER_ADDRESS:$MPORT \
--compute_canada \
--iterative_cluster VAL.BATCH_SIZE 32 ITERCLUSTER.METHOD 'kmeans' DATA.SAMPLE_DURATION 16 ITERCLUSTER.K 5000
