...
#SBATCH --job-name=kin_16fr_r3d_p0.5
...
tar -xzf /home/cheny257/projects/def-florian7/datasets/kinetics400/frames_shortedge320px_25fps/val_split.tar.gz -C $SLU>
echo 'Extracted val zip'
tar -xzf /home/cheny257/projects/def-florian7/datasets/kinetics400/frames_shortedge320px_25fps/train_split.tar.gz -C $S>
...
--batch_size 140 \
--output $ROOTDIR/output_ucf29-kin-r3d-single_0.5 \
--epoch 601 VAL.BATCH_SIZE 80 LOSS.LOCAL_LOCAL_CONTRAST True \
DATA.INPUT_CHANNEL_NUM 3 ITERCLUSTER.METHOD finch ITERCLUSTER.FINCH_PARTITION [0,2] \
DATA.SAMPLE_DURATION 16 DATASET.POSITIVE_SAMPLING_P 0.5
