...
--batch_size 48 \
--checkpoint_path /home/cheny257/projects/def-florian7/cheny257/code/video_similarity_search/output_ucf29-kin-r3d-single_0.5/tnet_checkpoints/3dresnet/checkpoint.pth.tar \
...
DATA.SAMPLE_DURATION 32 DATASET.POSITIVE_SAMPLING_P 0.5
