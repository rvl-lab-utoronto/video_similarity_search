...
#SBATCH --job-name=kin_16fr_r3d_p0.7
...
--batch_size 140 \
--output $ROOTDIR/output_ucf29-kin-r3d-single_0.7 \
--checkpoint_path "/home/cheny257/projects/def-florian7/cheny257/code/video_similarity_search/output_ucf29-kin-r3d-single_0.7/tnet_checkpoints/3dresnet/checkpoint.pth.tar" \
--epoch 601 VAL.BATCH_SIZE 80 LOSS.LOCAL_LOCAL_CONTRAST True \
DATA.INPUT_CHANNEL_NUM 3 ITERCLUSTER.METHOD finch ITERCLUSTER.FINCH_PARTITION [0,3] \
DATA.SAMPLE_DURATION 16 DATASET.POSITIVE_SAMPLING_P 0.7
