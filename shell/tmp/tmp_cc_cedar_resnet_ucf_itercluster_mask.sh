...
#SBATCH --job-name=resnet_ucf_mask_iterclusterlr0.1
...
--num_data_workers 4 \
--batch_size 120 \
--output '/home/cheny257/projects/def-florian7/cheny257/output/resnet_ucf_mask_itercluster_lr0.1' \
--checkpoint_path '/home/cheny257/projects/def-florian7/cheny257/output/resnet_ucf_mask_itercluster_lr0.1/tnet_checkpoints/3dresnet/checkpoint.pth.tar' \
--num_shards 2 \
--epoch 800 \
